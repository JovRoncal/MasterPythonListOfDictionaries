...
for university in university_list:
    print(f"University Name: {university['name']}, Location: {university['location']}, Established Year: {university['established_year']}, Type: {university['type']}, Website: {university['website']}")