...
for restaurant in restaurant_list:
    print(f"Restaurant Name: {restaurant['name']}, Location: {restaurant['location']}, Cuisine Type: {restaurant['cuisine_type']}, Established Year: {restaurant['established_year']}, Website/Contact: {restaurant['website_or_contact']}")